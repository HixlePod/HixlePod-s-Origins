...
public class ItemInit {
    ...
    public static final RegistryObject<Item> CUSTOM_COAL = VANILLA_ITEMS.register("coal", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_CHARCOAL = VANILLA_ITEMS.register("charcoal", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_DIAMOND = VANILLA_ITEMS.register("diamond", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_EMERALD = VANILLA_ITEMS.register("emerald", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_LAPIS_LAZULI = VANILLA_ITEMS.register("lapis_lazuli", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_RAW_COPPER = VANILLA_ITEMS.register("raw_copper", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_COPPER_INGOT = VANILLA_ITEMS.register("copper_ingot", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_RAW_GOLD = VANILLA_ITEMS.register("raw_gold", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_GOLD_INGOT = VANILLA_ITEMS.register("gold_ingot", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_NETHERITE_INGOT = VANILLA_ITEMS.register("netherite_ingot", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_NETHERITE_SCRAP = VANILLA_ITEMS.register("netherite_scrap", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_STICK = VANILLA_ITEMS.register("stick", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));

    public static final RegistryObject<Item> CUSTOM_RAW_IRON = VANILLA_ITEMS.register("raw_iron", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_IRON_INGOT = VANILLA_ITEMS.register("iron_ingot", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));

    public static final RegistryObject<Item> CUSTOM_PAPER = VANILLA_ITEMS.register("paper", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_BOOK = VANILLA_ITEMS.register("book", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));

    public static final RegistryObject<Item> CUSTOM_GUNPOWDER = VANILLA_ITEMS.register("gunpowder", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_SLIMEBALL = VANILLA_ITEMS.register("slime_ball", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_TOTEM_OF_UNDYING = VANILLA_ITEMS.register("totem_of_undying", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).stacksTo(16).food(new FoodProperties.Builder().build())));

    public static final RegistryObject<Item> CUSTOM_BROWN_MUSHROOM = VANILLA_ITEMS.register("brown_mushroom", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS).stacksTo(64).food(new FoodProperties.Builder().build())));
    public static final RegistryObject<Item> CUSTOM_RED_MUSHROOM = VANILLA_ITEMS.register("red_mushroom", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS).stacksTo(64).food(new FoodProperties.Builder().build())));

    public static final RegistryObject<Item> CUSTOM_BONE = VANILLA_ITEMS.register("bone", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(64).food(new FoodProperties.Builder().nutrition(1).fast().build())));

    public static final RegistryObject<BlockItem> CUSTOM_DIRT = VANILLA_ITEMS.register("dirt", () -> new BlockItem(Blocks.DIRT, new Item.Properties().tab(CreativeModeTab.TAB_BUILDING_BLOCKS).stacksTo(64).food(new FoodProperties.Builder().build())));
