...
public class KeyInit {
    ...
    public static final String KEY_ABILITY_3 = "key." + HixlePodsOrigins.MODID + ".ability_3";
    ...
    public static final KeyMapping ABILITY_3 = new KeyMapping(KEY_ABILITY_3, KeyConflictContext.IN_GAME, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_B, KEY_CATEGORY);
