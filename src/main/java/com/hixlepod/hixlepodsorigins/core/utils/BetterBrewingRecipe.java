...
public class BetterBrewingRecipe implements IBrewingRecipe {
    ...
    private final Item ingedient;
    private final Potion output;

    public BetterBrewingRecipe(Potion input, Item ingedient, Potion output) {
        this.input = input;
    ...
    @Override
    public boolean isIngredient(ItemStack ingredient) { return ingredient.getItem() == this.ingedient; }
