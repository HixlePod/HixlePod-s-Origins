...
public class CompassModel extends HierarchicalModel<EntityCompass> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(HixlePodsOrigins.MODID, "compass"), "main");

    public CompassModel(ModelPart p_170427_) {
        this.root = p_170427_;
    ...
    public void setupAnim(EntityCompass p_102200_, float p_102201_, float p_102202_, float p_102203_, float p_102204_, float p_102205_) {
