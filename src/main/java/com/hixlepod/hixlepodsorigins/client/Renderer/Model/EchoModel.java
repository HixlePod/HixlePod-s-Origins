...
public class EchoModel<Type extends EntityEcho> extends ColorableAgeableListModel<Type>{
    ...
    public EchoModel(ModelPart p_171087_) {
    ...
    public void prepareMobModel(Type p_104132_, float p_104133_, float p_104134_, float p_104135_) {
    ...
    public void setupAnim(Type p_104137_, float p_104138_, float p_104139_, float p_104140_, float p_104141_, float p_104142_) {
