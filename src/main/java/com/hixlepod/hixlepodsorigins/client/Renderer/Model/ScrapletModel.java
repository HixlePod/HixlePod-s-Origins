...
public class ScrapletModel<T extends EntityScraplet> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(HixlePodsOrigins.MODID, "scraplet"), "main");
    ...
    public ScrapletModel(ModelPart p_170984_) {
        this.root = p_170984_;
