...
public class NPCModel<T extends Animal> extends AgeableListModel<T> implements ArmedModel, HeadedModel {

    //public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(HixlePodsOrigins.MODID, "npc_nimbus"), "main");
    ...
    public NPCModel(ModelPart p_170679_, Function<ResourceLocation, RenderType> p_170680_) {
    ...
    private void poseRightArm(T p_102876_) {
        switch (this.rightArmPose) {
            ...
            default:
                this.rightArmPose.applyTransform(humanoidModel, p_102876_, net.minecraft.world.entity.HumanoidArm.RIGHT);
        }
    ...
    private void poseLeftArm(T p_102879_) {
        switch (this.leftArmPose) {
            ...
            default:
                this.leftArmPose.applyTransform(humanoidModel, p_102879_, net.minecraft.world.entity.HumanoidArm.LEFT);
        }
    ...
    public static enum ArmPose implements net.minecraftforge.common.IExtensibleEnum {
        ...
        public static HumanoidModel.ArmPose create(String name, boolean twoHanded, @javax.annotation.Nonnull net.minecraftforge.client.IArmPoseTransformer forgeArmPose) {
