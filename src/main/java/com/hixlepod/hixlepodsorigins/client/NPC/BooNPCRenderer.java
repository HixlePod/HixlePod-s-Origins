...
public class BooNPCRenderer<Type extends EntityBooNPC> extends MobRenderer<Type, NPCModel<Type>> {
    ...
    public BooNPCRenderer(EntityRendererProvider.Context context) {
