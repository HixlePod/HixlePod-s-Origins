...
public class FloElytraLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    private final FloElytraModel<T> elytraModel;

    public FloElytraLayer(RenderLayerParent<T, M> p_174493_, EntityModelSet p_174494_) {
        super(p_174493_);
        this.elytraModel = new FloElytraModel<>(p_174494_.bakeLayer(ModelLayers.ELYTRA));
    }
    ...
    public boolean shouldRender(T entity) {
        return entity.getName().equals(Component.literal(Flo_Plays_.NAME));
    }
