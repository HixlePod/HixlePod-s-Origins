...
import com.hixlepod.hixlepodsorigins.client.OnCharacters.Model.WhirlElytraModel;
...
public class WhirlElytraLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    public static final ModelLayerLocation WINGS_LOCATION = new ModelLayerLocation(new ResourceLocation(HixlePodsOrigins.MODID,"textures/wings/whirl_wings.png"), "main");
    private final WhirlElytraModel<T> elytraModel;

    public WhirlElytraLayer(RenderLayerParent<T, M> p_174493_, EntityModelSet p_174494_) {
        super(p_174493_);
        this.elytraModel = new WhirlElytraModel<>(p_174494_.bakeLayer(ModelLayers.ELYTRA));
    }
    ...
    public boolean shouldRender(T entity) {
        return entity.getName().equals(Component.literal(AmbrosiaElf.NAME));
    }
