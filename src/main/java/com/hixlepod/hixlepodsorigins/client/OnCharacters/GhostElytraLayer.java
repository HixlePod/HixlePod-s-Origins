...
public class GhostElytraLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    public static final ModelLayerLocation WINGS_LOCATION = new ModelLayerLocation(new ResourceLocation(HixlePodsOrigins.MODID,"textures/wings/ghost_wings.png"), "main");
    private final GhostElytraModel<T> elytraModel;

    public GhostElytraLayer(RenderLayerParent<T, M> p_174493_, EntityModelSet p_174494_) {
        super(p_174493_);
        this.elytraModel = new GhostElytraModel<>(p_174494_.bakeLayer(ModelLayers.ELYTRA));
    }
    ...
    public boolean shouldRender(T entity) {
        return entity.getName().equals(Component.literal(gh0stlure.NAME));
    }
