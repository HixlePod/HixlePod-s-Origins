...
public enum HardQuestsPool implements QuestPools {
    ...
    HardQuestsPool(double WEIGHT, String DISPLAY_NAME, String DESCRIPTION, ItemStack WANTED_ITEM, ItemStack REWARD) {
        this.weight = WEIGHT;
