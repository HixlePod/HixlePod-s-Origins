...
public class ArtificalMemes {

    public static String NAME = "ArtificialMemes";
    ...
    public static void setAbilityData(Player player) {
        ...
        player.getServer().getPlayerList().getPlayerByName(ArtificalMemes.NAME).onUpdateAbilities();
    }
