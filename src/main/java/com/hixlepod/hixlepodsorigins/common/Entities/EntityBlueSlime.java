...
public class EntityBlueSlime extends Mob implements Enemy {
    private static final EntityDataAccessor<Integer> ID_SIZE = SynchedEntityData.defineId(EntityBlueSlime.class, EntityDataSerializers.INT);
    ...
    public EntityBlueSlime(EntityType<? extends EntityBlueSlime> p_33588_, Level p_33589_) {
        super(p_33588_, p_33589_);
        this.moveControl = new EntityBlueSlime.SlimeMoveControl(this);
    }

    protected void registerGoals() {
        this.goalSelector.addGoal(1, new EntityBlueSlime.SlimeFloatGoal(this));
        this.goalSelector.addGoal(2, new EntityBlueSlime.SlimeAttackGoal(this));
        this.goalSelector.addGoal(3, new EntityBlueSlime.SlimeRandomDirectionGoal(this));
        this.goalSelector.addGoal(5, new EntityBlueSlime.SlimeKeepOnJumpingGoal(this));
    ...
    public EntityType<? extends EntityBlueSlime> getType() {
        return (EntityType<? extends EntityBlueSlime>)super.getType();
    }
    ...
    public static boolean checkSlimeSpawnRules(EntityType<EntityBlueSlime> p_219113_, LevelAccessor p_219114_, MobSpawnType p_219115_, BlockPos p_219116_, RandomSource p_219117_) {
    ...
    static class SlimeAttackGoal extends Goal {
        private final EntityBlueSlime slime;
        private int growTiredTimer;

        public SlimeAttackGoal(EntityBlueSlime p_33648_) {
            this.slime = p_33648_;
        ...
        public boolean canUse() {
            ...
            if (livingentity == null) {
                ...
                return !this.slime.canAttack(livingentity) ? false : this.slime.getMoveControl() instanceof EntityBlueSlime.SlimeMoveControl;
            }
        }
        ...
        public void tick() {
            ...
            ((EntityBlueSlime.SlimeMoveControl)this.slime.getMoveControl()).setDirection(this.slime.getYRot(), this.slime.isDealsDamage());
        }
    }
    ...
    static class SlimeFloatGoal extends Goal {
        ...
        public SlimeFloatGoal(EntityBlueSlime p_33655_) {
            this.slime = p_33655_;
        ...
        public boolean canUse() {
            return (this.slime.isInWater() || this.slime.isInLava()) && this.slime.getMoveControl() instanceof EntityBlueSlime.SlimeMoveControl;
        }
        ...
        public void tick() {
            ...
            ((EntityBlueSlime.SlimeMoveControl)this.slime.getMoveControl()).setWantedMovement(1.2D);
        }
    }
    ...
    static class SlimeKeepOnJumpingGoal extends Goal {
        ...
        public SlimeKeepOnJumpingGoal(EntityBlueSlime p_33660_) {
            this.slime = p_33660_;
            this.setFlags(EnumSet.of(Goal.Flag.JUMP, Goal.Flag.MOVE));
        }
        ...
        public void tick() {
            ((EntityBlueSlime.SlimeMoveControl)this.slime.getMoveControl()).setWantedMovement(1.0D);
        }
    }
    ...
    static class SlimeMoveControl extends MoveControl {
        ...
        public SlimeMoveControl(EntityBlueSlime p_33668_) {
            super(p_33668_);
            this.slime = p_33668_;
    ...
    static class SlimeRandomDirectionGoal extends Goal {
        ...
        public SlimeRandomDirectionGoal(EntityBlueSlime p_33679_) {
            this.slime = p_33679_;
            this.setFlags(EnumSet.of(Goal.Flag.LOOK));
        }
        ...
        public void tick() {
            ...
            ((EntityBlueSlime.SlimeMoveControl)this.slime.getMoveControl()).setDirection(this.chosenDegrees, false);
        }
    }
}
